...
- `App.gba` file from this repository is the built C program, compiled using a Docker image for a consistent development environment. The image includes all necessary tools to ensure smooth compilation. It is compatible with any Game Boy Advance (GBA) emulator.
